...
const DoctorDetails = () => {
  ...
  <div className="flex flex-col sm:flex-row items-center gap-2">
    <img src="/www1.png" alt="Client" className="w-12 h-12 sm:w-auto sm:h-auto" />
...
<div className=" flex max-w-3xl mx-auto mt-10 p-5">
  <img src={doctor.img} alt={doctor.title} className="w-full rounded-lg" />
  <div className="flex flex-col md:flex-row gap-5 mt-5">
    <div className="w-full">
      ...
      <img className="mt-5 w-full rounded-lg" src="/image89.png" alt="Doctors" />
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        ...
        <h4 className="text-button py-1 px-3 bg-blue-300 rounded-lg">Trends</h4>
        <h4 className="text-button py-1 px-3 bg-blue-300 rounded-lg">Design</h4>
        <h4 className="text-button py-1 px-3 bg-blue-300 rounded-lg">Research</h4>
      </div>
    ...
    <div className="md:shadow-lg rounded-2xl w-full md:w-auto h-fit mt-5 p-3">
      ...
      <form action="">
        <input className="border border-button py-1 px-2 rounded-lg text-button w-full focus:border-2 focus:border-button outline-none" type="text" placeholder="Email address" />
